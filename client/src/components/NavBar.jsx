...
const NavBar = ({ user }) => {
    ...
    const updateNotificationStatus = async (notificationId) => {
        await Api.post('/api/user/notification/read', { notificationId: notificationId }, {
            headers: {
                Authorization: token.replace(/"/g, '')
            }
        })
                            ...
                            {notifications.length > 0 ? (
                                notifications.map((notification, index) => (
                                    <li
                                        ...
                                        className={notification.read ? 'text-gray-500' : 'text-blue-900'}
                                    >
                                            ...
                                            <a href={notification.link} >
                                                ...
                                                {notification.read ? null : (
                                                    <span>
                                                        <FontAwesomeIcon
                                                            icon={faCircle}
                                                            style={{ color: "#25519d", fontSize: '10px' }}
                                                        />
                                                    </span>
                                                )}
                                            </a>
